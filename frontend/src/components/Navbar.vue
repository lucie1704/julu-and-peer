      ...
      <nav aria-label="Top" class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="border-b border-gray-200">
          <div class="flex h-16 items-center">
            ...
            <div class="relative">
              <input id="search" name="search" class="block w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 placeholder-gray-400" placeholder="Search" type="search">
            ...
            <div class="ml-auto flex items-center">
              <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                <router-link class="text-sm font-medium text-gray-700 hover:text-gray-800" to="/login" v-if="!isLoggedIn">Login</router-link>
                <span class="h-6 w-px bg-gray-200" aria-hidden="true" />
                <router-link class="text-sm font-medium text-gray-700 hover:text-gray-800" to="/signup" v-if="!isLoggedIn">Signup</router-link>
                <router-link  @click="logout"  v-if="isLoggedIn" class="text-sm font-medium text-gray-700 hover:text-gray-800" to="/signup">Logout</router-link>
              </div>
              ...
              <div class="ml-4 flow-root lg:ml-6">
                <router-link class="group -m-2 flex items-center p-2" to="/customer/shopping-carts">
