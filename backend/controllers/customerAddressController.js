...
exports.createCustomerAddress = catchAsyncError (async (req, res, next) => {
...
exports.getAllCustomerAddresses = catchAsyncError(async (req, res) => {
    const customerAddresses = await CustomerAddress.findAll();
    return responseReturn(res, customerAddresses);
});

exports.getCustomerAddressById = catchAsyncError (async (req, res, next) => {
...
exports.deleteCustomerAddress = catchAsyncError(async (req, res, next) => {
